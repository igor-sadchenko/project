...
namespace local {
	...
	Frame::Frame(HINSTANCE hInstance, HINSTANCE hInstanceRes, sk::string AppName, sk::string ClassName) :
	...
	LRESULT Frame::OnFrameMessage(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam, BOOL bHandle)
	{
		LRESULT result = 0;
		switch (message)
		{
