...
namespace cfh {
	...
	private:
		...
		SKAPIRES FixRequestForPositions();
		SKAPIRES FixAccountInfoRequest();
		void FixRequestForPositionsAck(const libfix::_AO__*);
		void FixPositionReport(const libfix::_AP__*);
		void FixAccountInfo(const libfix::_AAB__*);
	private:
