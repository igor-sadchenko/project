...
namespace client {
	...
	class IExchangeTreeNodeUI final : public CListContainerElementUI {
	public:
		void SetID(const shared::SystemID&);
		void SetExchange(const sk::stringa&);
		void SetModule(const sk::stringa&);
...
#endif
		void Set(const shared::SystemProduct&,const sk::container::set<shared::LPProduct>&,const sk::container::set<shared::MTFeederProduct>&,const sk::container::set<shared::MTGatewayProduct>&);
